...
public class OHA32 extends OHA<OHA32.Property> {
	
	private static final long serialVersionUID = -5280215298710757602L;
	...
	public static enum Property {
		 ...
		 * However, the values for this field are inconsistent with different
		 * versions of the Microsoft linker. This field is not present in 64-bit
		 * executables.
		 */
		BASE_OF_DATA(DWORD, "BaseOfData"),
		 ...
		 */
		SIZE_OF_HEAP_RESERVE(DWORD, "SizeOfHeapReserve"),
		
		/**
		 * In EXE files, the size of memory committed to the heap. By default, this
		 * is 4KB.
		 */
		SIZE_OF_HEAP_COMMIT(DWORD, "SizeOfHeapCommit"),
	...
	// BASE_OF_DATA field is part of the standard header. Has been moved here as
	// pe32plus does not use this.
	static int SIZE_OF = 72;
	
	public OHA32(ByteBuffer bytes) {
